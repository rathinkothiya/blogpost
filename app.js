...
//connect mongodb
mongoose.connect('mongodb+srv://admin:admin@cluster0.ccnzs.mongodb.net/blogpost', {
...
app.get('/posts/:postName',function(req,res){
  const requestedTitle = _.lowerCase(req.params.postName);
        ...
        Item.findOne({title: _.lowerCase(requestedTitle)}, function(err, foundList) {
